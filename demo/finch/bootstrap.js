...
// Add the missing "native" timer functionality
...
(function()
 {
   ...
   /**
    * Process a GET request. These provide an alternate means of issuing RPC
    * calls.
    *
    * @param request {Packages.javax.servlet.http.HttpServletRequest}
    *   The object containing the request parameters.
   ...
   /**
    * Create a Java array from a JavaScript array.
    *
    * @param type {Packages.*}
