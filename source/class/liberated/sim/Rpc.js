 ...
 */
qx.Class.define("liberated.sim.Rpc",
{
  ...
  construct : function(url)
  {
    ...
    liberated.sim.Simulator.registerHandler(
  ...
  members :
  {
     ...
     * 
     * @param request {Map}
     *   A map of data for this request. See {@link
     *   liberated.sim.Simulator#post} for details.
     * 
     * @responseHeaders {Map}
