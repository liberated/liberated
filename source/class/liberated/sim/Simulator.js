 ...
 */
qx.Class.define("liberated.sim.Simulator",
{
  statics :
  {
    ...
    {
      liberated.sim.Simulator.__handlers.push(handler);
    },
    ...
    post : function(request)
    {
      ...
      var             Simulator = liberated.sim.Simulator;
  ...
  defer : function()
  {
    liberated.sim.Simulator.__timerManager = qx.util.TimerManager.getInstance();
  }
});
