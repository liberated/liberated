...
qx.Class.define("liberated.sim.Dbif",
{
  ...
  statics :
  {
    ...
    query : function(classname, searchCriteria, resultCriteria)
    {
      ...
      dbObjectMap = liberated.sim.Dbif.Database[type];
      ...
      case "Array":
        ...
        searchCriteria = liberated.sim.Dbif._buildCompositeKey(searchCriteria);
    ...
    put : function(entity)
    {
      ...
      case "Null":
        ...
        case "Key":
        case "Number":
          key = liberated.sim.Dbif.__nextKey++;
          break;
          
        case "String":
          key = String(liberated.sim.Dbif.__nextKey++);
          break;
      ...
      case "Array":
        ...
        key = liberated.sim.Dbif._buildCompositeKey(key);
        break;
      ...
      liberated.sim.Dbif.Database[type][key] = data;
    ...
    remove : function(entity)
    {
      ...
      delete liberated.sim.Dbif.Database[type][key];
