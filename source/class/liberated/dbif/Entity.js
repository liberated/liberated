...
qx.Class.define("liberated.dbif.Entity",
{
  ...
  construct : function(entityType, entityKey)
  {
    ...
    keyField = propertyTypes.keyField || this.getEntityKeyProperty();
    
    // FIXME: Remove these two lines and eliminate the entityKeyProperty
    // property entirely.
    this.setEntityKeyProperty(keyField);
    propertyTypes.keyField = keyField;
